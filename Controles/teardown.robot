...
Esse aqui também vai passar com uma condição e vai parar de executar as keywords abaixo!
    ${STATUS}   Run Keyword And Return Status   Should Be True    "Evra" == "Evra"
    Log  ${STATUS}
    Pass Execution If    ${STATUS}    message=Evra é igual a Evra, então passou!!

Esse keyword vai passar sozinha!
    Should Be True    "Evra" == "Evra"

Esse keyword vai falhar sozinha!
    Should Be True    "Evra" == "João"
